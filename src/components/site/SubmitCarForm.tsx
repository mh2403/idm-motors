...
export function SubmitCarForm() {
  ...
  async function onSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    setWhatsAppUrl(
      `https://wa.me/32495159162?text=${encodeURIComponent(whatsAppMessage)}`,
    );
    ...
    return (
      <>
        ...
        <AlertDialog open={showWhatsAppPrompt} onOpenChange={setShowWhatsAppPrompt}>
          <AlertDialogContent>
            <AlertDialogHeader>
              <AlertDialogTitle>Laat de eigenaar weten dat je een formulier verstuurd hebt</AlertDialogTitle>
              <AlertDialogDescription>
